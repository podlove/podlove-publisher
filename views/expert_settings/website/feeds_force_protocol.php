...
<p>
<?php echo __( 'If you are using a certificate provider not supported by iTunes (like Let\'s Encrypt), you need to select option 3. Podlove Publisher will then force feed URLs as well as enclosure and image URLs within the feed to be http only.', 'podlove-podcasting-plugin-for-wordpress' ) ?></p>
<h4>
