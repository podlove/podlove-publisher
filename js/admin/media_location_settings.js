 ...
 */
var MediaLocationSettings = (function($) {
	...
	function generate_live_preview() {
		...
		$('input[name*="url_template"]').on( 'keyup', o.update_preview );
		$('input[name*="suffix"]').on( 'keyup', o.update_preview );
		$('#podlove_show_media_file_base_uri').on( 'keyup', o.update_preview );
		$('[name*="media_format_id"]').on( 'change', o.update_preview );
		o.update_preview();
	}
