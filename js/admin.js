...
function clean_up_input() {
	...
	$(".podlove-check-input").on('change', function() {
		...
		// Remove Whitespaces at the beginning and end for every Podlove Input Field
		textfield.val( textfield.val().trim() );

		/* 
		 * Check if there are specific intructions what to do with the content of the text field
		 *
		 * * data-podlove-input-type: one of [url, avatar, email]
		 * * data-podlove-input-remove: a list of characters that will be removed from the textfield value e.g. "['@', '+']"
		 */
