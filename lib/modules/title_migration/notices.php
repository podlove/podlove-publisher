...
class Notices {
	...
	public function the_init_notice()
	{
		...
		<div class="notice notice-warning">
			...
			<p>
				<a class="button" href="<?php echo admin_url('admin.php?page=podlove_tools_settings_handle#the_tools_section'); ?>"><?php echo __('Take me to the tool', 'podlove-podcasting-plugin-for-wordpress') ?></a> <a href="<?php echo admin_url('admin.php?page=' . $_REQUEST['page'] . '&podlove_set_title_migration_state=' . State::INITIALIZED_HIDDEN); ?>"><?php echo __('hide this message', 'podlove-podcasting-plugin-for-wordpress') ?></a>
			</p>
		</div>	
		<?php
	}
	...
	public function the_finished_notice()
	{
		...
		<div class="notice notice-warning">
			...
			<p>
				<a class="button" href="<?php echo admin_url('admin.php?page=podlove_settings_modules_handle&podlove_disable_title_migration_module=1'); ?>"><?php echo __('Deactivate Title Migration Module', 'podlove-podcasting-plugin-for-wordpress') ?></a> <a href="<?php echo admin_url('admin.php?page=' . $_REQUEST['page'] . '&podlove_set_title_migration_state=' . State::FINISHED_HIDDEN); ?>"><?php echo __('hide this message', 'podlove-podcasting-plugin-for-wordpress') ?></a>
			</p>
		</div>	
		<?php
	}
