...
class GrowthBanner
{
    const DISMISSED_OPTION = 'podlove_plus_growth_banner_dismissed';
    ...
    private function should_render()
    {
        ...
        if ($this->published_episode_count() < self::MIN_EPISODES) {
            return false;
        }

        if (isset($_GET['page']) && $_GET['page'] === 'publisher_plus_settings') {
            return false;
        }
    ...
    private function is_plus_configured()
    {
        $podcast = Podcast::get();
    ...
    private function published_episode_count()
    {
