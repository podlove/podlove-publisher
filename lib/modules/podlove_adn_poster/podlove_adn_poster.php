    ...
    public function load() {
			...
			if($this->get_module_option('adn_poster_auth') == "") {
				$this->register_option( 'adn_poster_auth', 'string', array(
					...
					'description' => __( '<strong style="color: red;">You need to authorize Podlove to use your App.net account.</strong> To do so please start the authorization process <a target="_blank" href="http://adn-auth.podlove.org/adnauth.php?step=1">here</a>.', 'podlove' ),
