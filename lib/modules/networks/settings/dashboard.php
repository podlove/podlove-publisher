...
class Dashboard {
	...
	public static function settings_page() {
		...
		add_meta_box( Dashboard::$pagehook . '_network_overview', __( 'Networks', 'podlove' ), '\Podlove\Modules\Networks\Settings\Dashboard::network_overview', Dashboard::$pagehook, 'normal' );
