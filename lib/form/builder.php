...
class Builder {
	function form_textarea_input() {
		?>
		<textarea name="<?php echo $this->field_name; ?>" id="<?php echo $this->field_id; ?>" <?php if ( $this->class ): ?>class="<?php echo $this->class; ?>"<?php endif; ?>><?php echo $this->field_value; ?></textarea>
		<?php
	}
	
	function form_text_input() {
		?>
		<input type="text" name="<?php echo $this->field_name; ?>" value="<?php echo $this->field_value; ?>" id="<?php echo $this->field_id; ?>" <?php if ( $this->class ): ?>class="<?php echo $this->class; ?>"<?php endif; ?>>
		<?php
	}

	function form_select_input() {
		?>
		<select name="<?php echo $this->field_name; ?>" id="<?php echo $this->field_id; ?>" <?php if ( $this->class ): ?>class="<?php echo $this->class; ?>"<?php endif; ?>>
	...
	function form_checkbox_input() {
		...
		?>
		<input type="checkbox" name="<?php echo $this->field_name; ?>" id="<?php echo $this->field_id; ?>" <?php if ( $this->field_value ): ?>checked="checked"<?php endif; ?> <?php if ( $this->class ): ?>class="<?php echo $this->class; ?>"<?php endif; ?>>
		<?php
	}
		...
		foreach ( $this->args[ 'options' ] as $key => $value ) {
			...
			<div>
				<label for="<?php echo $id; ?>">
					<input type="checkbox" name="<?php echo $name; ?>]" id="<?php echo $id; ?>" <?php if ( $checked ): ?>checked="checked"<?php endif; ?> <?php echo $callback; ?> <?php if ( $this->class ): ?>class="<?php echo $this->class; ?>"<?php endif; ?>> <?php echo $value; ?>
				</label>
			</div>
			<?php
		}
