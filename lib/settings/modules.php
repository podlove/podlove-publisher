			...
			add_settings_field(
				...
				/* $callback */ function () use ( $module, $module_name, $module_options ) {
					...
					if ( $module_options ) {
						...
						\Podlove\Form\build_for( $settings_object, array( 'context' => $module->get_module_options_name(), 'submit_button' => false, 'form' => false, 'nonce_action' => 'update_module_settings' ), function ( $form ) use ( $module_options ) {
