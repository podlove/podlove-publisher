...
class EpisodeAsset {
	...
	public function page() {
		...
		<div class="wrap">
			...
			<h2><?php echo __( 'Episode Assets', 'podlove-podcasting-plugin-for-wordpress' ); ?> <a href="?page=<?php echo $_REQUEST['page']; ?>&amp;action=new" class="add-new-h2"><?php echo __( 'Add New', 'podlove-podcasting-plugin-for-wordpress' ); ?></a></h2>
			<?php
			$action = isset( $_REQUEST['action'] ) ? $_REQUEST['action'] : NULL;
			switch ( $action ) {
