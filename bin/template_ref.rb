...
def templateRefClasses
	classes = %w{podcast episode network list chapter feed asset file image tag category duration file_type contributor contributor_group season service license flattr datetime}
